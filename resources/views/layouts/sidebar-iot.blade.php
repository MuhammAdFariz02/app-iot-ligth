...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box mt-3">
        ...
        <a href="/dashboard" class="logo logo-dark">
            <span class="logo-sm">
                <img src="{{ URL::asset('build/images/lamp.png') }}" alt="" height="60">
            </span>
            <span class="logo-lg">
                <img src="{{ URL::asset('build/images/Lamp-IoT.png') }}" alt="" height="40">
            </span>
        </a>
        <!-- Light Logo-->
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="/lampu">
                        <i class="ri-honour-line"></i> <span> Lampu </span>
                    </a>
                </li>
            </ul>
        </div>
